...
void main() {
  group('KalmanFilter', () {
    ...
    test('filters out noise on constant signal', () {
      ...
      final measurements = <double>[
        ...
        100, 98, 102, 100, 99, 101, 100, 98, 102, 100,
      ];
  ...
  group('AdaptiveKalmanFilter', () {
    ...
    test('tracks fast-changing signal better than base Kalman', () {
      final baseFilter = KalmanFilter(processNoise: 0.01, measurementNoise: 0.1);
      ...
      expect(filter.currentEstimate, greaterThanOrEqualTo(baseFilter.currentEstimate));
    });
  });
}
